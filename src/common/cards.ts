...
const categoriesByOriginIds = {
  simple: {
    ...
    ids: [
      ...
      187, 191, 194, 197, 198, 199,
    ],
  },
  athletic: {
    title: 'Сила любви',
    ids: [
      2, 11, 23, 37, 45, 50, 54, 61, 64, 66, 69, 75, 93, 98, 101, 103, 104, 109, 111, 117, 119, 128, 129, 137, 139, 157,
      166, 168, 171, 176, 179, 181, 182, 183, 186, 193,
    ],
  },
  tricky: {
    ...
    ids: [
      ...
      127, 132, 134, 136, 141, 148, 152, 174, 190, 192,
    ]
  },
  onlyWoman: {
    title: 'Она будет довольна',
    ids: [8, 20, 51, 53, 68, 80, 88, 99, 124, 128, 149, 161, 169, 171, 178, 188, 189, 200,],
  },
  sheTop: {
    title: 'Её счастье сверху',
    ids: [
      1, 3, 6, 9, 17, 18, 27, 29, 32, 33, 36, 38, 40, 41, 48, 60, 61, 67, 70, 75, 81, 82, 89, 90, 94, 96, 98, 103, 108,
      111, 115, 117, 119, 120, 122, 123, 127, 129, 140, 142, 143, 150, 153, 158, 166, 169, 175, 182, 190, 191, 199,
    ]
  },
  onlyMan: {
    title: 'Соблазни его',
    ids: [11, 12, 15, 25, 31, 34, 43, 74, 86, 95, 97, 102, 107, 135, 138, 146, 163, 196,],
  },
  heFromBack: {
    title: 'Вид с зади',
    ids: [
  ...
  heTop: {
    ...
    ids: [
      ...
      110, 112, 113, 141, 152, 154, 156, 157, 159, 164, 167, 173, 176, 181, 183, 187, 192, 197, 199,
    ],
  },
  anal: {
    title: 'Вход через заднюю дверь',
    ids: [10, 24, 39, 56, 57, 58, 65, 73, 76, 82, 83, 90, 101, 116, 121, 123, 125, 131, 140, 145, 186, 197,],
  },
  onTheTable: {
    title: 'Накрываем на стол',
    ids: [5, 14, 23, 58, 61, 75, 79, 87, 101, 104, 126, 131, 190,]
  },
  onTheChair: {
    title: '12 стульев',
    ids: [
      13, 26, 32, 42, 47, 64, 66, 92, 97, 98, 111, 115, 117, 122, 126, 129, 132, 139, 148, 160, 172, 179, 185, 186, 189,
      192, 199,
    ],
  },
  fitBall: {
    title: 'Команда вводит мяч в игру',
    ids: [8, 21, 61, 69, 75, 101, 119, 137, 165, 166, 168,]
  },
  inTheBed: {
    title: 'Любовное ложе',
    ids: [
      ...
      130, 133, 134, 135, 136, 138, 140, 141, 142, 143, 144, 145, 146, 147, 149, 151, 152, 153, 154, 155, 156, 158, 159,
      161, 162, 163, 164, 169, 170, 173, 174, 175, 176, 178, 180, 181, 182, 184, 187, 188, 191, 195, 196, 197, 198,
    ],
  },
  onThePoof: {
    title: 'Отличный пуфик',
    ids: [2, 4, 12, 13, 22, 26, 27, 62, 65, 70, 92, 122, 150, 160, 183, 185, 190,]
  },
  onTheFloor: {
    title: 'Пол больше чем кровать',
    ids: [11, 24, 37, 45, 50, 54, 57, 79, 87, 88, 93, 109, 128, 145, 157, 165, 167, 171, 177, 183, 186, 193, 194, 200,]
  },
  six9: {
    title: '69',
    ids: [22, 55, 63, 130, 144, 162, 172, 195,]
  }
}
