...
const categoriesByOriginIds = {
  simple: {
    ...
    ids: [
      ...
      67, 70, 71, 72, 73, 76, 77, 79, 81, 82, 83, 84, 87, 90, 94, 96, 110, 112, 114, 116, 118,
    ],
  },
  athletic: {
    title: 'Сила любви',
    ids: [2, 11, 23, 37, 45, 50, 54, 61, 64, 66, 69, 75, 93, 98, 101, 103, 104, 109, 111, 117,],
  },
  tricky: {
    title: 'Хитро-выдуманные',
    ids: [
      1, 13, 16, 26, 27, 28, 33, 36, 40, 41, 42, 47, 48, 78, 85, 89, 91, 92, 100, 105, 106, 108, 113, 115,
    ]
  },
  onlyWoman: {
    title: 'Она будет довольна',
    ids: [8, 20, 51, 53, 68, 80, 88, 99,],
  },
  sheTop: {
  ...
  onlyMan: {
    title: 'Соблазни его',
    ids: [11, 12, 15, 25, 31, 34, 43, 74, 86, 95, 97, 102, 107],
  },
  heFromBack: {
    title: 'Вид с зади',
    ids: [
  ...
  anal: {
    ...
    ids: [10, 24, 39, 56, 57, 58, 65, 73, 76, 82, 83, 90, 101, 116,],
  },
  onTheTable: {
    title: 'Накрываем на стол',
    ids: [5, 14, 23, 58, 61, 75, 79, 87, 101, 104]
  },
  onTheChair: {
    title: '12 стульев',
    ids: [13, 26, 32, 42, 47, 64, 66, 92, 97, 98, 111, 115, 117],
  },
  fitBall: {
    title: 'Команда вводит мяч в игру',
    ids: [8, 21, 61, 69, 75, 101,]
  },
  inTheBed: {
    title: 'Любовное ложе',
    ids: [
      ...
      94, 95, 96, 99, 100, 102, 103, 105, 106, 107, 108, 110, 112, 113, 114, 116, 118,
    ],
  },
  onThePoof: {
    title: 'Отличный пуфик',
    ids: [2, 4, 12, 13, 22, 26, 27, 62, 65, 70, 92,]
  },
  onTheFloor: {
    title: 'Пол больше чем кровать',
    ids: [11, 24, 37, 45, 50, 54, 57, 79, 87, 88, 93, 109,]
  },
  six9: {
    title: '69',
    ids: [22, 55, 63,]
...
const categories = _.chain(categoriesByOriginIds)
  .mapValues(category => category.ids = category.ids.map(id => id + cardsOffset - 1))
