...
const categoriesByOriginIds = {
  simple: {
    ...
    ids: [
      ...
      187, 191, 194, 197, 198, 199, 201, 203, 206, 207, 208, 210, 211, 216, 218, 220, 221, 224, 227, 230, 236, 237, 239,
  ...
  athletic: {
    ...
    ids: [
      ...
      166, 168, 171, 176, 179, 181, 182, 183, 186, 193, 204, 214, 215, 222, 225, 226, 229, 232, 233, 234, 241, 249, 253,
  ...
  tricky: {
    ...
    ids: [
      ...
      266, 269, 281, 289, 295, 317, 318, 324, 339, 341, 344, 346, 349, 351, 353, 358, 364,
    ]
  },
  onlyWoman: {
    ...
    ids: [
      ...
      278, 302, 315, 320, 325, 328, 331, 338, 340, 342, 351, 357,
    ],
  },
  sheTop: {
    ...
    ids: [
      ...
      111, 115, 117, 119, 120, 122, 123, 127, 129, 140, 142, 143, 150, 153, 158, 166, 169, 175, 182, 190, 191, 199, 201,
  ...
  anal: {
    ...
    ids: [
      ...
      220, 236, 238, 239, 246, 250, 254, 255, 258, 264, 277, 280, 284, 293, 297, 317, 318, 323, 334, 337, 345, 363,
    ],
  },
  onTheTable: {
  ...
  inTheBed: {
    ...
    ids: [
      ...
      161, 162, 163, 164, 169, 170, 173, 174, 175, 176, 178, 180, 181, 182, 184, 187, 188, 191, 195, 196, 197, 198, 201,
      202, 204, 205, 206, 208, 209, 210, 211, 212, 213, 214, 218, 220, 223, 224, 226, 227, 230, 232, 235, 238, 239, 240,
