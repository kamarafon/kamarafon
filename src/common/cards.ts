...
enum CategoryTag {
  Simple, Tricky, Athletics, OnlyShe, OnlyHe, SixNine
}
...
const newCategories: NewCategoryType[] = [
  ...
  },
  {
    ...
    name: '69',
    ids: {
      [CategoryTag.OnlyShe]: [/* todo programming */]
    },
  },
  {
    title: 'отлько она',
